...
github_preview_role=profile-github-preview-role
...
aws iam put-role-policy --role-name "$codebuild_role" --policy-name preview-image-build \
  --policy-document "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"WritePreviewBuildLogs\",\"Effect\":\"Allow\",\"Action\":[\"logs:CreateLogGroup\",\"logs:CreateLogStream\",\"logs:PutLogEvents\"],\"Resource\":\"*\"},{\"Sid\":\"GetECRLoginToken\",\"Effect\":\"Allow\",\"Action\":\"ecr:GetAuthorizationToken\",\"Resource\":\"*\"},{\"Sid\":\"PushAndReadPreviewImages\",\"Effect\":\"Allow\",\"Action\":[\"ecr:BatchCheckLayerAvailability\",\"ecr:BatchGetImage\",\"ecr:CompleteLayerUpload\",\"ecr:DescribeImages\",\"ecr:GetDownloadUrlForLayer\",\"ecr:InitiateLayerUpload\",\"ecr:PutImage\",\"ecr:UploadLayerPart\"],\"Resource\":\"arn:aws:ecr:$region:$account_id:repository/profile-api\"}]}"

codebuild_policy="{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"PreviewOrchestration\",\"Effect\":\"Allow\",\"Action\":[\"ecs:RegisterTaskDefinition\",\"ecs:RunTask\",\"ecs:ListTasks\",\"ecs:DescribeTasks\",\"ecs:DescribeServices\",\"ecs:CreateService\",\"ecs:UpdateService\",\"ecs:DeleteService\",\"ecs:DescribeTaskDefinition\",\"ecs:TagResource\",\"servicediscovery:ListNamespaces\",\"servicediscovery:ListServices\",\"servicediscovery:CreateService\",\"servicediscovery:DeleteService\",\"servicediscovery:TagResource\",\"secretsmanager:CreateSecret\",\"secretsmanager:DescribeSecret\",\"secretsmanager:DeleteSecret\",\"secretsmanager:GetRandomPassword\",\"secretsmanager:TagResource\",\"lambda:CreateFunction\",\"lambda:GetFunction\",\"lambda:GetPolicy\",\"lambda:ListTags\",\"lambda:UpdateFunctionCode\",\"lambda:UpdateFunctionConfiguration\",\"lambda:DeleteFunction\",\"lambda:AddPermission\",\"lambda:GetFunctionConfiguration\",\"lambda:TagResource\",\"ec2:DescribeSecurityGroups\",\"ec2:DescribeSubnets\",\"ec2:DescribeVpcs\",\"apigateway:GET\",\"apigateway:POST\",\"apigateway:DELETE\"],\"Resource\":\"*\"},{\"Sid\":\"PassPreviewTaskRoles\",\"Effect\":\"Allow\",\"Action\":\"iam:PassRole\",\"Resource\":[\"arn:aws:iam::$account_id:role/$task_execution_role\",\"arn:aws:iam::$account_id:role/$task_role\",\"arn:aws:iam::$account_id:role/$bootstrap_execution_role\"],\"Condition\":{\"StringEquals\":{\"iam:PassedToService\":\"ecs-tasks.amazonaws.com\"}}},{\"Sid\":\"PassPreviewLambdaRole\",\"Effect\":\"Allow\",\"Action\":\"iam:PassRole\",\"Resource\":\"arn:aws:iam::$account_id:role/$lambda_execution_role\",\"Condition\":{\"StringEquals\":{\"iam:PassedToService\":\"lambda.amazonaws.com\"}}}]}"
aws iam put-role-policy --role-name "$codebuild_role" --policy-name preview-orchestration --policy-document "$codebuild_policy"
aws iam put-role-policy --role-name "$github_preview_role" --policy-name start-preview-codebuild \
  --policy-document "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"StartPreviewBuild\",\"Effect\":\"Allow\",\"Action\":\"codebuild:StartBuild\",\"Resource\":\"arn:aws:codebuild:$region:$account_id:project/profile-preview-deploy\"},{\"Sid\":\"ReadPreviewBuildStatus\",\"Effect\":\"Allow\",\"Action\":\"codebuild:BatchGetBuilds\",\"Resource\":\"arn:aws:codebuild:$region:$account_id:project/profile-preview-deploy\"},{\"Sid\":\"ReadPreviewBuildLogs\",\"Effect\":\"Allow\",\"Action\":\"logs:GetLogEvents\",\"Resource\":\"arn:aws:logs:$region:$account_id:log-group:/aws/codebuild/profile-preview-deploy:*\"},{\"Sid\":\"ReadPreviewImageDigest\",\"Effect\":\"Allow\",\"Action\":\"ecr:DescribeImages\",\"Resource\":\"arn:aws:ecr:$region:$account_id:repository/profile-api\"},{\"Sid\":\"ReadPreviewApiGatewayDomain\",\"Effect\":\"Allow\",\"Action\":\"apigateway:GET\",\"Resource\":\"arn:aws:apigateway:$region::/domainnames/*\"}]}"
