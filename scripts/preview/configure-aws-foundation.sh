...
codebuild_policy="{\"Version\":\"2012-10-17\",\"Statement\":[{\"Sid\":\"PreviewOrchestration\",\"Effect\":\"Allow\",\"Action\":[\"ecs:RegisterTaskDefinition\",\"ecs:RunTask\",\"ecs:DescribeTasks\",\"ecs:DescribeServices\",\"ecs:CreateService\",\"ecs:UpdateService\",\"ecs:DeleteService\",\"ecs:DescribeTaskDefinition\",\"servicediscovery:ListNamespaces\",\"servicediscovery:ListServices\",\"servicediscovery:CreateService\",\"servicediscovery:DeleteService\",\"secretsmanager:CreateSecret\",\"secretsmanager:DescribeSecret\",\"secretsmanager:DeleteSecret\",\"secretsmanager:GetRandomPassword\",\"secretsmanager:TagResource\",\"lambda:CreateFunction\",\"lambda:GetFunction\",\"lambda:UpdateFunctionCode\",\"lambda:UpdateFunctionConfiguration\",\"lambda:DeleteFunction\",\"lambda:AddPermission\",\"lambda:GetFunctionConfiguration\",\"apigatewayv2:CreateApi\",\"apigatewayv2:GetApis\",\"apigatewayv2:DeleteApi\",\"apigatewayv2:CreateIntegration\",\"apigatewayv2:GetIntegrations\",\"apigatewayv2:CreateRoute\",\"apigatewayv2:GetRoutes\",\"apigatewayv2:CreateDomainName\",\"apigatewayv2:GetDomainName\",\"apigatewayv2:GetDomainNames\",\"apigatewayv2:DeleteDomainName\",\"apigatewayv2:CreateApiMapping\",\"apigatewayv2:GetApiMappings\"],\"Resource\":\"*\"},{\"Sid\":\"PassPreviewTaskRoles\",\"Effect\":\"Allow\",\"Action\":\"iam:PassRole\",\"Resource\":[\"arn:aws:iam::$account_id:role/$task_execution_role\",\"arn:aws:iam::$account_id:role/$task_role\",\"arn:aws:iam::$account_id:role/$bootstrap_execution_role\"],\"Condition\":{\"StringEquals\":{\"iam:PassedToService\":\"ecs-tasks.amazonaws.com\"}}},{\"Sid\":\"PassPreviewLambdaRole\",\"Effect\":\"Allow\",\"Action\":\"iam:PassRole\",\"Resource\":\"arn:aws:iam::$account_id:role/$lambda_execution_role\",\"Condition\":{\"StringEquals\":{\"iam:PassedToService\":\"lambda.amazonaws.com\"}}}]}"
