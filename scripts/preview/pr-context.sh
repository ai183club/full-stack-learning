...
emit cloud_map_service "profile-api-pr-${PR_NUMBER}"
emit lambda_function "profile-api-lambda-pr-${PR_NUMBER}"
emit api_gateway_name "profile-api-http-pr-${PR_NUMBER}"
emit database_secret_name "profile-learning/postgres/pr-${PR_NUMBER}"
